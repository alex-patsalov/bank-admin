...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        Pet pet1 = new Pet(Species.Dog, "Sam", 2, 60, new String[]{"eat", "sleep"});
        ...
        Pet pet2 = new Pet(Species.Cat, "smarty", 2, 70, new String[]{"trick", "eat"});
        ...
        for (int i = 0; i < 40000; i++) {
            ...
            Pet pet3 = new Pet(Species.Dog, "Jujka", 2, 60, new String[]{"eat", "sleep"});
